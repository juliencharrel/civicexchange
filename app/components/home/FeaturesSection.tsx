      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white/10 rounded-lg p-6">
            ...
            <div className="text-sm">Webinaires, ateliers et salons à venir. <Button variant="secondary" className="underline ml-1 px-0 py-0 h-auto bg-transparent text-white hover:text-secondary">Voir l'agenda</Button></div>
          </div>
        </div>
        <div className="mt-8 flex flex-col md:flex-row gap-4 items-center">
          <input type="text" placeholder="Nom de votre collectivité" className="px-4 py-2 rounded text-primary w-full md:w-auto" />
