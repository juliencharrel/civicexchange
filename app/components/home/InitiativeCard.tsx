  ...
  return (
    <div className="bg-white rounded-lg shadow p-6 mb-6">
      <div className="flex items-center gap-2 mb-2">
        <span className="text-[var(--color-secondary)] font-bold">Participation citoyenne</span>
      ...
      <div className="flex flex-wrap gap-6 mb-4">
        <div>
          <div className="text-[var(--color-primary)] font-bold">+230%</div>
          <div className="text-xs text-gray-500">Satisfaction</div>
        </div>
        <div>
          <div className="text-[var(--color-primary)] font-bold">89%</div>
          <div className="text-xs text-gray-500">Adoption</div>
        </div>
        <div>
          <div className="text-[var(--color-primary)] font-bold">15,000</div>
          <div className="text-xs text-gray-500">Participants</div>
        </div>
        <div>
          <div className="text-[var(--color-primary)] font-bold">2M€</div>
